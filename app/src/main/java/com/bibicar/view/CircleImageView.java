...
/**
 * Created by jackie on 2017/6/28 11:51.
 * QQ : 971060378
 * Used as : 自定义圆形ImageView
 */
public class CircleImageView extends ImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        BitmapShader mBitmapShader = new BitmapShader(bmp, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);//渲染图像，使用图像为绘制图形着色
